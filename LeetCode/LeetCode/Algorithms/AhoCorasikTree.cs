...
// This source code is taken from https://github.com/alexandrnikitin/AhoCorasick.Net/blob/master/src/AhoCorasick.Net/AhoCorasickTree.cs
public class AhoCorasickTree
{
    ...
    public AhoCorasickTree(string[] keywords)
    {
        if ((keywords?.Length ?? 0) == 0)
            throw new ArgumentException("Can not be null or empty", nameof(keywords));
